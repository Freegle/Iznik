...
Welcome. This is the help and guidance for Freegle: how the website and app work, and how
the people who look after Freegle keep it running.
...
These pages explain **how Freegle works**. They do not cover Freegle the charity itself,
such as its people, its money, or how it is run. That is kept elsewhere.

If you help write these pages, please read **[how we keep the docs up to date](maintaining-docs.md)**
first. The short version: we update a page whenever we change the thing it describes, and
the pictures are taken automatically from the real app rather than added by hand.
