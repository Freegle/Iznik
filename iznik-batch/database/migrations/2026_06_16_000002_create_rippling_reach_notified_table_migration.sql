-- Idempotent production SQL for 2026_06_16_000002_create_rippling_reach_notified_table.php
--
...
CREATE TABLE IF NOT EXISTS rippling_reach_notified (
    msgid       BIGINT UNSIGNED NOT NULL,
    userid      BIGINT UNSIGNED NOT NULL,
    notified_at TIMESTAMP       NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (msgid, userid),
    INDEX rippling_reach_notified_userid_index (userid),
    CONSTRAINT rippling_reach_notified_msgid_foreign FOREIGN KEY (msgid)
        REFERENCES messages (id) ON DELETE CASCADE,
    CONSTRAINT rippling_reach_notified_userid_foreign FOREIGN KEY (userid)
