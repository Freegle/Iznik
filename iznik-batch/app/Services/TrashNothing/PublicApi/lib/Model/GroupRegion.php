 ...
 */
class GroupRegion implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Group_region';
     ...
     * Sets name
     *
     * @param string|null $name The name of the region.
     *
     * @return self
     */
     ...
     * Sets abbreviation
     *
     * @param string|null $abbreviation A 2 letter abbreviation for the region (is not guaranteed to be globally unique but is unique among all the regions in the country).
     *
     * @return self
     */
