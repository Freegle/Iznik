...
/**
 * GetPostsByIds200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetPostsByIds200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'get_posts_by_ids_200_response';
     ...
     * Sets not_found
     *
     * @param string[]|null $not_found The IDs of posts that weren't found (may have been deleted or never existed).
     *
     * @return self
     */
     ...
     * Sets forbidden
     *
     * @param string[]|null $forbidden The IDs of posts that are forbidden for the current user.
     *
     * @return self
     */
