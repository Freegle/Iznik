...
/**
 * GroupMembershipQuestionnaire Class Doc Comment
 *
 * @category Class
 ...
 */
class GroupMembershipQuestionnaire implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Group_membership_questionnaire';
     ...
     * Sets message
     *
     * @param string|null $message A message from the group moderators to be displayed above the questions (may be null).
     *
     * @return self
     */
     ...
     * Sets questions
     *
     * @param string[]|null $questions The list of questions.
     *
     * @return self
     */
