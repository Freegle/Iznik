...
class GroupMembership implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Group_membership';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'date' => '\DateTime',
        'questionnaire' => '\OpenAPI\Client\Model\GroupMembershipQuestionnaire'
    ];
     ...
     * Sets status
     *
     * @param string|null $status One of: subscribed, pending, pending-questions
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The UTC date and time when the membership was last updated.
     *
     * @return self
     */
     ...
     * Gets questionnaire
     *
     * @return \OpenAPI\Client\Model\GroupMembershipQuestionnaire|null
     */
     ...
     * Sets questionnaire
     *
     * @param \OpenAPI\Client\Model\GroupMembershipQuestionnaire|null $questionnaire questionnaire
     *
     * @return self
     */
