...
/**
 * GroupCountry Class Doc Comment
 *
 * @category Class
 ...
 */
class GroupCountry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Group_country';
     ...
     * Sets abbreviation
     *
     * @param string|null $abbreviation A 2 letter country code for the country (see https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2 ).
     *
     * @return self
     */
