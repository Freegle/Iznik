...
/**
 * ST_Y(point) - the Y-coordinate (latitude, in this codebase's convention -
 ...
 * a Polygon) is a MySQL ERROR (3516 "... unexpected type ... in st_y"), not
 * a NULL result - verified empirically (see StX). Callers must ensure the
 * operand is known to be a Point.
 *
 ...
 */
final class StY implements ExpressionContract
{
    use RendersOperands;
    ...
    {
        return 'ST_Y('.$this->renderOperand($this->point, $grammar).')';
    }
}
