 ...
 *
 * MySQL semantics: returns NULL if ANY operand is NULL (unlike CONCAT_WS -
 * see ConcatWs). Cover this in tests.
 *
 ...
 */
final class Concat implements ExpressionContract
{
    use RendersOperands;
    ...
    {
        if (count($operands) < 2) {
            throw new InvalidArgumentException('Concat requires at least 2 operands.');
        }
    ...
    public function getValue(Grammar $grammar): string
    {
        ...
        return 'CONCAT('.implode(', ', $rendered).')';
    }
}
