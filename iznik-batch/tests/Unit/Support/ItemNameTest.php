...
class ItemNameTest extends TestCase
{
    public static function courtesyProvider(): array
    {
        return [
            ...
            'empty separator collapsed' => [
                'Coloured plastic hangers - adult size - will split',
                'Coloured plastic hangers - will split',
            ],
            ...
            'compound proper noun survives' => [
                'Raffle/Tombola Prizes For Girl Guide Fundraiser',
                'Raffle/Tombola Prizes For Girl Guide Fundraiser',
            ],
            'conjunction of audiences survives' => [
