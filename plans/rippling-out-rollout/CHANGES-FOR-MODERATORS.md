...
handy if you ever want to check how far a post has spread, or sanity-check why it turned
up on your list. Brand-new posts show the area they're *about* to start in.

### 3. A reminder when you edit a shared post
If you edit a post that's on more than one community, you'll see a warning:
...
If you do reject a post that rippled in from another community (a "secondary" rejection),
two things happen, and both are deliberate:

1. **The person who posted it is *not* told.** They posted to their own community and it's
   still happily visible there; a faraway group saying "not for us" isn't something they
   need to hear about, so we don't bother them with it.
2. **The post simply stops showing in your community's area.** It carries on being visible
