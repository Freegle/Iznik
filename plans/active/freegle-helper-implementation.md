...
| 4 | Frontend rework + vitest | ✅ | 29 new specs + full suite (13356) green |
| 5 | Validate + screenshots + PR | ✅ | PR #838; screenshots from dev-local (local apiv2); sass+icon bugs fixed |
