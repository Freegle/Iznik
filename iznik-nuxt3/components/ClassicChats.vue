...
<script setup>
// The classic chats page, unchanged, rendered inside the login layout when a member
// has chosen classic Freegle. The chat-shell version is components/chatshell/ChatList
// and MemberChat.
