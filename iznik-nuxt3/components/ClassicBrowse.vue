...
<script setup>
// The classic browse page, unchanged, rendered inside the login layout when a member has
// chosen classic Freegle. In chat mode /browse is the Nearby screen instead.
