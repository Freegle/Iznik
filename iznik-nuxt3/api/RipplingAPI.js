...
export default class RipplingAPI extends BaseAPI {
  ...
  // trialOnly=true restricts every KPI query to groups currently in rippling_reach
  // (the RIPPLE_WITHIN_GROUPS trial groups) so the stats are not diluted by the
  // majority of groups that are not yet part of the trial.
